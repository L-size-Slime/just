...
(function ($)
{
    $.fn.printPage = function (options)
    {
        ...
        var pluginOptions = {
            attr: "target",
            url: false,
            message: "请稍候，正在创建文档"//Please wait while we create your document
        };
        ...
        var components = {
          ...
          width:310px; height:120px; z-index: 1000; font-size:16px; padding:10px; color:#222; font-family:helvetica, arial;\
          opacity:0;\
